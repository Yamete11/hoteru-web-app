        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Room>(t =>
            {
                t.HasData(
                    ...
                    new Room { IdRoom = 2, Number = "102", Capacity = 2, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 2 },
                    new Room { IdRoom = 3, Number = "103", Capacity = 3, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 4, Number = "104", Capacity = 4, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 5, Number = "105", Capacity = 5, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 6, Number = "106", Capacity = 6, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 2 },
                    new Room { IdRoom = 7, Number = "107", Capacity = 7, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 8, Number = "108", Capacity = 8, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 9, Number = "109", Capacity = 9, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    ...
                    new Room { IdRoom = 12, Number = "203", Capacity = 12, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 13, Number = "204", Capacity = 13, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 14, Number = "205", Capacity = 14, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 2 },
                    new Room { IdRoom = 15, Number = "206", Capacity = 15, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 16, Number = "207", Capacity = 16, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 17, Number = "208", Capacity = 17, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 18, Number = "209", Capacity = 18, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 2 },
                    new Room { IdRoom = 19, Number = "301", Capacity = 19, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 20, Number = "302", Capacity = 20, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 21, Number = "303", Capacity = 21, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 22, Number = "304", Capacity = 22, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 2 },
                    new Room { IdRoom = 23, Number = "305", Capacity = 23, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 24, Number = "306", Capacity = 24, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 25, Number = "307", Capacity = 25, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 26, Number = "308", Capacity = 26, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 27, Number = "309", Capacity = 27, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 28, Number = "401", Capacity = 28, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 2 },
                    new Room { IdRoom = 29, Number = "402", Capacity = 29, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 30, Number = "403", Capacity = 30, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 31, Number = "404", Capacity = 31, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 },
                    new Room { IdRoom = 32, Number = "405", Capacity = 32, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 2 },
                    new Room { IdRoom = 33, Number = "406", Capacity = 33, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 3 },
                    new Room { IdRoom = 34, Number = "407", Capacity = 34, Price = 3.5f, IdRoomType = 1, IdRoomStatus = 1 });
