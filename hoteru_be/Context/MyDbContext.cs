        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Service>(t =>
            {
                t.HasData(
                    ...
                    new Service { IdService = 4, Title = "Laundry", Sum = 40.0f, Description = "Daily laundry service" },
                    new Service { IdService = 5, Title = "Parking", Sum = 75.0f, Description = "Underground parking" },
                    new Service { IdService = 6, Title = "Room Cleaning", Sum = 30.0f, Description = "Extra room cleaning" },
                    new Service { IdService = 7, Title = "Mini Bar", Sum = 60.0f, Description = "Mini bar refill" },
                    new Service { IdService = 8, Title = "City Tour", Sum = 150.0f, Description = "2-hour guided tour" },
                    new Service { IdService = 9, Title = "Gym Access", Sum = 45.0f, Description = "24/7 access" },
                    new Service { IdService = 10, Title = "Pool Access", Sum = 55.0f, Description = "Outdoor pool" },
                    new Service { IdService = 11, Title = "Sauna", Sum = 65.0f, Description = "Private sauna session" },
                    new Service { IdService = 12, Title = "Massage", Sum = 95.0f, Description = "1-hour massage" },
                    new Service { IdService = 13, Title = "Dinner", Sum = 300.0f, Description = "Buffet dinner" },
                    new Service { IdService = 14, Title = "Late Checkout", Sum = 80.0f, Description = "Until 18:00" },
                    new Service { IdService = 15, Title = "Early Check-in", Sum = 70.0f, Description = "From 6:00 AM" },
                    new Service { IdService = 16, Title = "Pet Stay", Sum = 100.0f, Description = "Pet-friendly room" },
                    new Service { IdService = 17, Title = "Airport Pickup", Sum = 200.0f, Description = "Luxury car" },
                    new Service { IdService = 18, Title = "Baggage Service", Sum = 20.0f, Description = "Porter assistance" },
                    new Service { IdService = 19, Title = "WiFi", Sum = 15.0f, Description = "Premium internet" },
                    new Service { IdService = 20, Title = "Business Center", Sum = 50.0f, Description = "Printing & scanning" },
                    new Service { IdService = 21, Title = "Conference Room", Sum = 250.0f, Description = "Per hour" },
                    new Service { IdService = 22, Title = "Translation", Sum = 180.0f, Description = "On-site translator" },
                    new Service { IdService = 23, Title = "Courier Service", Sum = 90.0f, Description = "Express delivery" },
                    new Service { IdService = 24, Title = "Photo Session", Sum = 300.0f, Description = "In-hotel shoot" },
                    new Service { IdService = 25, Title = "Birthday Package", Sum = 400.0f, Description = "Cake, balloons" },
                    new Service { IdService = 26, Title = "Anniversary Package", Sum = 500.0f, Description = "Romantic setup" },
                    new Service { IdService = 27, Title = "Wine Tasting", Sum = 280.0f, Description = "Local wines" },
                    new Service { IdService = 28, Title = "Babysitter", Sum = 220.0f, Description = "Certified staff" },
                    new Service { IdService = 29, Title = "Car Rental", Sum = 600.0f, Description = "Luxury car" },
                    new Service { IdService = 30, Title = "Bike Rental", Sum = 60.0f, Description = "Per day" }
                );
            });
