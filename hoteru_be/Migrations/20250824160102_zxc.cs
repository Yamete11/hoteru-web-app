    ...
    public partial class zxc : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "zxc", new DateTime(2025, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Noah", "Wilson", new DateTime(2025, 6, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "108", 140m });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, 3, 1, 2, "101", 45m },
                    { 28, 28, 3, 2, 15, "401", 145m },
                    { 29, 29, 3, 2, 15, "402", 150m },
                    { 30, 30, 3, 2, 15, "403", 125m },
                    { 31, 31, 3, 2, 15, "404", 135m },
                    { 32, 32, 3, 2, 15, "405", 100m },
                    { 33, 33, 3, 2, 15, "406", 110m },
                    { 34, 34, 3, 2, 15, "407", 95m },
                    { 25, 25, 3, 2, 15, "307", 85m },
                    { 24, 24, 3, 2, 15, "306", 95m },
                    { 23, 23, 3, 2, 15, "305", 135m },
                    { 22, 22, 3, 2, 15, "304", 125m },
                    { 21, 21, 3, 2, 15, "303", 115m },
                    { 20, 20, 3, 2, 2, "302", 110m },
                    { 19, 19, 3, 2, 2, "301", 100m },
                    { 18, 18, 3, 1, 2, "209", 135m },
                    { 17, 17, 3, 1, 2, "208", 140m },
                    { 16, 16, 3, 1, 2, "207", 105m },
                    { 2, 2, 2, 1, 2, "102", 75m },
                    { 3, 3, 2, 1, 2, "103", 60m },
                    { 4, 4, 3, 1, 2, "104", 90m },
                    { 5, 5, 2, 1, 2, "105", 85m },
                    { 6, 6, 2, 1, 2, "106", 65m },
                    { 7, 7, 2, 1, 2, "107", 55m },
                    { 27, 27, 3, 2, 15, "309", 140m },
                    { 8, 8, 1, 1, 2, "108", 70m },
                    { 10, 10, 2, 1, 2, "201", 95m },
                    { 11, 11, 3, 1, 2, "202", 100m },
                    { 12, 12, 3, 1, 2, "203", 120m },
                    { 13, 13, 3, 1, 2, "204", 130m },
                    { 14, 14, 3, 1, 2, "205", 75m },
                    { 15, 15, 3, 1, 2, "206", 85m },
                    { 9, 9, 2, 1, 2, "109", 110m },
                    { 26, 26, 3, 2, 15, "308", 125m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 28, "Certified staff", 15, 220m, "Babysitter" },
                    { 25, "Cake, balloons", 15, 400m, "Birthday Package" },
                    { 26, "Romantic setup", 15, 500m, "Anniversary Package" },
                    { 27, "Local wines", 15, 280m, "Wine Tasting" },
                    { 23, "Express delivery", 2, 90m, "Courier Service" },
                    { 24, "In-hotel shoot", 15, 300m, "Photo Session" },
                    { 22, "On-site translator", 2, 180m, "Translation" },
                    { 12, "1-hour massage", 2, 95m, "Massage" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 20, "Printing & scanning", 2, 50m, "Business Center" },
                    { 1, "None", 2, 355m, "Breakfast" },
                    { 2, "None", 2, 120m, "Spa" },
                    { 3, "None", 2, 248m, "Assistent" },
                    { 4, "Daily laundry service", 2, 40m, "Laundry" },
                    { 5, "Underground parking", 2, 75m, "Parking" },
                    { 6, "Extra room cleaning", 2, 30m, "Room Cleaning" },
                    { 7, "Mini bar refill", 2, 60m, "Mini Bar" },
                    { 8, "2-hour guided tour", 2, 150m, "City Tour" },
                    { 9, "24/7 access", 2, 45m, "Gym Access" },
                    { 10, "Outdoor pool", 2, 55m, "Pool Access" },
                    { 11, "Private sauna session", 2, 65m, "Sauna" },
                    { 29, "Luxury car", 15, 600m, "Car Rental" },
                    { 13, "Buffet dinner", 2, 300m, "Dinner" },
                    { 14, "Until 18:00", 2, 80m, "Late Checkout" },
                    { 15, "From 6:00 AM", 2, 70m, "Early Check-in" },
                    { 16, "Pet-friendly room", 2, 100m, "Pet Stay" },
                    { 17, "Luxury car", 2, 200m, "Airport Pickup" },
                    { 18, "Porter assistance", 2, 20m, "Baggage Service" },
                    { 19, "Premium internet", 2, 15m, "WiFi" },
                    { 21, "Per hour", 2, 250m, "Conference Room" },
                    { 30, "Per day", 15, 60m, "Bike Rental" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, true, null, 1, 5, 2, 1, new DateTime(2025, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), 150m },
                    { 2, 2, true, null, 2, 6, 3, 2, new DateTime(2025, 6, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 180m },
                    { 3, 3, true, null, 3, 7, 5, 3, new DateTime(2025, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), 340m },
                    { 4, 4, true, null, 4, 8, 6, 3, new DateTime(2025, 6, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), 325m },
                    { 5, 1, true, null, null, 9, 7, 3, new DateTime(2025, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 330m },
                    { 6, 2, true, 1, null, 10, 8, 3, new DateTime(2025, 6, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), 140m },
                    { 7, 3, false, null, null, 6, 9, 3, new DateTime(2025, 6, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), 330m },
                    { 8, 4, false, null, null, 11, 10, 3, new DateTime(2025, 6, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), 380m }
                });
